...
class PreLatentNorm(nn.Module):
    def __init__(self, type='none', enc_hid=None, dataset_num=None):
        ...
        if type == 'dsbn':
            self.norm = DSBNNorm(enc_hid, dataset_num, domain_label='batch')
        elif type == 'ln':
